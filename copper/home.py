...
item_date1=c1.text_input('item_date',"20210401")
customer1=c2.text_input('customer',"30218233")
country1=c3.text_input('country')
c4,c5,c6=st.columns(3)
application1=c4.text_input('application',"41")
thickness1=c5.text_input('thickness',"2")
width1=c6.text_input('width',"1200")
c7,c8,c9=st.columns(3)
product_ref1=c7.text_input('product_ref',"1668701718")
delivery_date1=c8.text_input('delivery date',"20210801")
selling_price1=c9.text_input('selling_price',"1136")
...
if test:
    ...
    classifier,x_test,y_test=status_classifier(new_df)
...
if test1:
    ...
    df4=clean_columns(df)
    new_df=sample_data(df4)
    regressor,x_test,y_test=sp_identifier(new_df)
